...
export default function BracketPage({ allTeams }) {
  ...
  return (
    <Layout
      ...
      description="Pit any 16 Kentucky teams against each other across 45 seasons. Who's the greatest team in Through the Rafters history?"
      canonical="/bracket/"
    >
      <Head>
